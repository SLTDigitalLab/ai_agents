...
* **Monthly KB Refresh Automation** — Production cron job refreshes LifeStore and Enterprise Qdrant collections and rebuilds the LifeStore Neo4j graph every month
...
### Common Monthly Refresh Troubleshooting
...
# ── Monthly KB Refresh Automation ─────────────────────────────────────────
RUN_QDRANT_INGESTIONS=true
RUN_NEO4J_GRAPH_REFRESH=true
ADMIN_BASE_URL=http://127.0.0.1:8000
ADMIN_USER_EMAIL=admin@slt.com.lk
