                        ...
                        {!loading && stats?.recent?.map((entry, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="grid grid-cols-12 gap-4 px-6 py-3.5 border-b border-white/[0.04] hover:bg-white/[0.03] transition-colors"
                                >
                                    ...
                                    <div className="col-span-3 text-white/40 text-xs font-mono truncate">
                                        {entry.thread_id.substring(0, 16)}...
                                    </div>
