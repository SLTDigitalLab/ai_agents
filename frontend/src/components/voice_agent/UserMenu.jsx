            ...
            <AnimatePresence>
                {showMenu && (
                    ...
                    >
                        ...
                        <button
                            onClick={onLogout}
                            className="w-full flex items-center gap-2.5 px-2 py-2 rounded-xl text-[0.82rem] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-white/[0.06] transition-all duration-150"
                        >
