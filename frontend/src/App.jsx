          ...
          <AuthenticatedTemplate>
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <motion.button
                ...
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300"
              >
                {/* Mic icon */}
