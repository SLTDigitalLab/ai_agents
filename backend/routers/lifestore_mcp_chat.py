            ...
            [
                (
                    ...
                    (
                        ...
                        "greeting, single_product, availability, category_browse, comparison, purchase, or general. "
                        "Use greeting when the message is a greeting, thanks, farewell, small talk, or a question about "
                        "who you are or what you can do. For greeting, do NOT recommend any product: set "
                ...
                (
                    ...
                    (
                        ...
                        "{"
                        "\"answer_mode\":\"greeting|single_product|availability|category_browse|comparison|purchase|general\","
...
def lifestore_mcp_chat(request: LifeStoreMCPChatRequest) -> dict[str, Any]:
    ...
    try:
        ...
        # Greetings / small talk: reply conversationally, never push a product.
        if answer_mode == "greeting":
            greeting_answer = _write_greeting_answer(message)
            return {
                "status": "success",
                "reply": greeting_answer,
                "answer": greeting_answer,
                "products": [],
                "retrieval": {"answer_mode": "greeting", "returned_products": 0},
                "tool_name": None,
                "answer_plan": plan,
                "form_payload": None,
                "frontend_contract": {
